...
tellraw @a{"rawtext":[{"text":"§4Astro §r §3→ "},{"selector":"@s"},{"text":"§0 Credit To Astro/Astroontop#6789 - Main Creator"}]}
tellraw @a{"rawtext":[{"text":"§4Astro §r §3→ "},{"selector":"@s"},{"text":"§0 Credit To Hydra/Hydraontop#0009 - Main Creator"}]}
