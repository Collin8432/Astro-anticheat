...
execute @s[tag=admin] ~~~ scoreboard players operation @a 30k = 30ktoggledummy 30k

#On
execute @s[tag=admin,scores={30k=1}] ~~~ scoreboard players set 30ktoggledummy 30kborder 1
...
execute @s[tag=admin,scores={60k=1}] ~~~ scoreboard players set 60ktoggledummy 60kborder 0
execute @s[tag=admin,scores={60k=1}] ~~~ scoreboard players operation @a 60kborder = 60ktoggledummy 60kborder
execute @s[tag=admin,scores={60k=1}] ~~~ scoreboard players set 60ktoggledummy 60k 0
...
#Off 
execute @s[tag=admin,scores={30k=2}] ~~~ scoreboard players set 30ktoggledummy 30kborder 0
execute @s[tag=admin,scores={30k=2}] ~~~ scoreboard players operation @a 30kborder = 30ktoggledummy 30kborder
execute @s[tag=admin,scores={30k=2}] ~~~ tellraw @a {"rawtext":[{"text":"§4Astro §r §3→ "},{"selector":"@s"},{"text":"§0 Has Toggled 30k Worldborder OFF"}]}
execute @s[tag=admin,scores={30k=2}] ~~~ scoreboard players set 30ktoggledummy 30k 0
