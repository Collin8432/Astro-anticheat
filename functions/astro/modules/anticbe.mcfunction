...
execute @s[scores={acbetoggle=1}] ~~~ kill @e[type=command_block_minecart]
execute @s[scores={acbetoggle=1}] ~~~ kill @e[type=command_block_minecart]
execute @s[scores={acbetoggle=1}] ~~~ kill @e[type=command_block_minecart]
execute @s[scores={acbetoggle=1}] ~~~ kill @e[type=command_block_minecart]
...
execute @r[tag=admin,scores={stafftag=0}] ~~~ tellraw @a {"rawtext":[{"text":"Astro → Flagged"},{"selector":"@s"},{"text":"For trying to getAdmin tag"}]}
execute @a[tag=admin,scores={stafftag=0}] ~~~ tag @s remove staffstatus
execute @r[tag=admin,scores={stafftag=0}] ~~~ tellraw @a {"rawtext":[{"text":"Astro → Flagged"},{"selector":"@s"},{"text":"For trying to getAdmin tag"}]}
execute @a[tag=admin,scores={stafftag=0}] ~~~ tag @s remove staff
execute @r[tag=admin,scores={admin=0}] ~~~ tellraw @a {"rawtext":[{"text":"Astro → Flagged"},{"selector":"@s"},{"text":"For trying to getAdmin tag"}]}
execute @a[tag=admin,scores={admin=0}] ~~~ tag @s remove admin
...
execute @s[scores={admin=0,acbetoggle=1}] ~ ~ ~ fill ~8 ~5 ~8 ~-8 ~-5 ~-8 air 0 replace flower_pot
...
execute @s[scores={admin=0,acbetoggle=1}] ~~~ clear @s command_block
execute @s[scores={admin=0,acbetoggle=1}] ~~~ clear @s chain_command_block
execute @s[scores={admin=0,acbetoggle=1}] ~~~ clear @s repeating_command_block
