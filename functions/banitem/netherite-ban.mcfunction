...
execute @s[tag=stafftag] ~~~ execute @s[scores={ibmtoggle=1}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAtomic §¶§b→ §6Netherite §bhas been §cBANNED §bby §d"},{"selector":"@s"}]}
...
scoreboard players set @s lstcmd 151
