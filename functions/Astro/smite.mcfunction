...
execute @s[tag=stafftag] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAstro → §bUnable to use smite on §d"},{"selector":"@s"},{"text":" §¶§bbecause they are staff."}]}

#Smite players
execute @s[tag=!stafftag] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAstro → §d"},{"selector":"@s"},{"text":" §¶§bwas smited by a operator"}]}
