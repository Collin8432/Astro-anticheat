...
execute @s[tag=stafftag,scores={OPAM=1}] ~~~ tellraw @s {"rawtext":[{"text":"§¶§cAstro §¶§b→ Access §cDENIED§7! §6Anti OP Abuse §bdisables this command"}]}
#init vanish mode
...
execute @s[tag=stafftag,scores={OPAM=0,vnsh=1}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAstro → §d"},{"selector":"@s"},{"text":" §¶§bHas §2ENABLED §6Vanish Mode"}]}
...
execute @s[tag=stafftag,scores={OPAM=0,vnsh=2}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAstro → §d"},{"selector":"@s"},{"text":" §¶§bHas §cDISABLED §6Vanish Mode"}]}
