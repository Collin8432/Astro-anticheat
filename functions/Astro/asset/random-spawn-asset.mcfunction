...
execute @s[scores={randomspawn=40..50}] ~~~ scoreboard players set @s x-axis 340
execute @s[scores={randomspawn=50..60}] ~~~ scoreboard players set @s x-axis 1201
execute @s[scores={randomspawn=60..70}] ~~~ scoreboard players set @s x-axis 860
execute @s[scores={randomspawn=70..80}] ~~~ scoreboard players set @s x-axis -380
execute @s[scores={randomspawn=80..90}] ~~~ scoreboard players set @s x-axis 1050
execute @s[scores={randomspawn=90..100}] ~~~ scoreboard players set @s x-axis 240
execute @s[scores={randomspawn=100..110}] ~~~ scoreboard players set @s x-axis 1088
execute @s[scores={randomspawn=110..120}] ~~~ scoreboard players set @s x-axis -1088
execute @s[scores={randomspawn=120..130}] ~~~ scoreboard players set @s x-axis 1008
execute @s[scores={randomspawn=130..140}] ~~~ scoreboard players set @s x-axis 1508
execute @s[scores={randomspawn=140..150}] ~~~ scoreboard players set @s x-axis 1038
execute @s[scores={randomspawn=150..160}] ~~~ scoreboard players set @s x-axis 1588
execute @s[scores={randomspawn=160..170}] ~~~ scoreboard players set @s x-axis -1988
execute @s[scores={randomspawn=170..180}] ~~~ scoreboard players set @s x-axis 1188
execute @s[scores={randomspawn=180..190}] ~~~ scoreboard players set @s x-axis -1388
execute @s[scores={randomspawn=190..200}] ~~~ scoreboard players set @s x-axis 1888
execute @s[scores={randomspawn=200..210}] ~~~ scoreboard players set @s x-axis -1688
execute @s[scores={randomspawn=210..220}] ~~~ scoreboard players set @s x-axis 1888
execute @s[scores={randomspawn=220..230}] ~~~ scoreboard players set @s x-axis -1688
execute @s[scores={randomspawn=230..240}] ~~~ scoreboard players set @s x-axis 1588
execute @s[scores={randomspawn=240..250}] ~~~ scoreboard players set @s x-axis -1788
execute @s[scores={randomspawn=250..260}] ~~~ scoreboard players set @s x-axis -1388
execute @s[scores={randomspawn=260..270}] ~~~ scoreboard players set @s x-axis 1988
execute @s[scores={randomspawn=270..280}] ~~~ scoreboard players set @s x-axis 8
execute @s[scores={randomspawn=280..290}] ~~~ scoreboard players set @s x-axis 1988
execute @s[scores={randomspawn=290..300}] ~~~ scoreboard players set @s x-axis 18
execute @s[scores={randomspawn=300..310}] ~~~ scoreboard players set @s x-axis 188
...
execute @s[scores={randomspawn=40..50}] ~~~ scoreboard players set @s z-axis 890
execute @s[scores={randomspawn=50..60}] ~~~ scoreboard players set @s z-axis 590
execute @s[scores={randomspawn=60..70}] ~~~ scoreboard players set @s z-axis -490
execute @s[scores={randomspawn=70..80}] ~~~ scoreboard players set @s z-axis 1002
execute @s[scores={randomspawn=80..90}] ~~~ scoreboard players set @s z-axis -790
execute @s[scores={randomspawn=90..100}] ~~~ scoreboard players set @s z-axis 990
execute @s[scores={randomspawn=100..110}] ~~~ scoreboard players set @s z-axis 785
execute @s[scores={randomspawn=110..120}] ~~~ scoreboard players set @s z-axis 785
execute @s[scores={randomspawn=120..130}] ~~~ scoreboard players set @s z-axis -785
execute @s[scores={randomspawn=130..140}] ~~~ scoreboard players set @s z-axis 285
execute @s[scores={randomspawn=140..150}] ~~~ scoreboard players set @s z-axis -285
execute @s[scores={randomspawn=150..160}] ~~~ scoreboard players set @s z-axis 685
execute @s[scores={randomspawn=160..170}] ~~~ scoreboard players set @s z-axis -585
execute @s[scores={randomspawn=170..180}] ~~~ scoreboard players set @s z-axis 1085
execute @s[scores={randomspawn=180..190}] ~~~ scoreboard players set @s z-axis 885
execute @s[scores={randomspawn=190..200}] ~~~ scoreboard players set @s z-axis -1585
execute @s[scores={randomspawn=200..210}] ~~~ scoreboard players set @s z-axis -1285
execute @s[scores={randomspawn=210..220}] ~~~ scoreboard players set @s z-axis 1305
execute @s[scores={randomspawn=220..230}] ~~~ scoreboard players set @s z-axis -1405
execute @s[scores={randomspawn=230..240}] ~~~ scoreboard players set @s z-axis -1505
execute @s[scores={randomspawn=240..250}] ~~~ scoreboard players set @s z-axis 1034
execute @s[scores={randomspawn=250..260}] ~~~ scoreboard players set @s z-axis 1046
execute @s[scores={randomspawn=260..270}] ~~~ scoreboard players set @s z-axis -1805
execute @s[scores={randomspawn=270..280}] ~~~ scoreboard players set @s z-axis -1805
execute @s[scores={randomspawn=280..290}] ~~~ scoreboard players set @s z-axis -1
execute @s[scores={randomspawn=290..300}] ~~~ scoreboard players set @s z-axis -1805
execute @s[scores={randomspawn=300..310}] ~~~ scoreboard players set @s z-axis -5
