...
execute @s[tag=!stafftag] ~~~ function Astro/asset/inv_look


#1.17 ban title messages  (06/22/2021)
execute @s[tag=!stafftag] ~~~ title @s[tag=PermBan] title §¶§cAstro → Banned | Globally
execute @s[tag=!stafftag] ~~~ title @s[tag=BanCreative] title §¶§cAstro → Banned | Creative Mode
execute @s[scores={acmtoggle=1}] ~~~ execute @s[tag=!stafftag] ~~~ title @s[tag=BanCBE] title §¶§cAstro → Banned | CBE
execute @s[tag=!stafftag] ~~~ title @s[tag=Ban] title §¶§cAstro → Banned | Manually
execute @s[scores={UOIM=1}] ~~~ execute @s[tag=!stafftag] ~~~ title @s[tag=illegalitemban] title §¶§cAstro → Banned | Illegals
execute @s[scores={afmtoggle=1}] ~~~ execute @s[tag=!stafftag] ~~~ title @s[tag=BanFly] title §¶§cAstro → Banned | Hacks
execute @s[scores={apmtoggle=1}] ~~~ execute @s[tag=!stafftag] ~~~ title @s[tag=BanPhase] title §¶§cAstro → Banned | Phase
execute @s[tag=!stafftag] ~~~ title @s[scores={warn=3}] title §¶§cAstro → Banned | 3 Warns
...
execute @s[scores={BanCBE=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAstro → §d"},{"selector":"@s"},{"text":"§b's §¶§cgot banned for CBE Exploits"}]}
execute @s[scores={BanWarn=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAstro → §d"},{"selector":"@s"},{"text":"§b's §¶§cgot banned for having 3 Warnings"}]}
execute @s[scores={PermBan=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAstro → §d"},{"selector":"@s"},{"text":" §¶§cogt banned for being Globally Banned"}]}
execute @s[scores={Ban=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAstro → §d"},{"selector":"@s"},{"text":" §¶§cgot banned by an Operator"}]}
execute @s[scores={IIB=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAstro → §d"},{"selector":"@s"},{"text":"§b's §¶§cgot banned for Illegal Items"}]}
execute @s[scores={BanFly=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAstro → §d"},{"selector":"@s"},{"text":"§b's §¶§cgot banned for Fly Hacks"}]}
execute @s[scores={BanPhase=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAstro → §d"},{"selector":"@s"},{"text":"§b's §¶§cgot banned for Phase."}]}
