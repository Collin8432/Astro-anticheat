...
#tag "kfc tommy6901" add PermBan
tag "Baked_Villian96" add PermBan
...
#kick @s[tag=PermBan] §¶§cAstro → You are Astro Global Banned! You may not join realms protected by Astro.
