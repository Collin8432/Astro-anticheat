...
execute @s[tag=stafftag,scores={HMM=2}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAstro §¶§b→ §6Hotbar Message §bhas been set to §2WITHOUT-SCORE §bmode §bby §d"},{"selector":"@s"}]}
#switch mode
...
execute @s[tag=stafftag,scores={HMM=3}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAstro §¶§b→ §6Hotbar Message §bhas been §cDISABLED §bby §d"},{"selector":"@s"}]}
