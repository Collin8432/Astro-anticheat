...
execute @s[scores={mdmtoggle=1}] ~~~ execute @s[tag=stafftag] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAtomic §¶§b→ §6Diamonds Alerts §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
